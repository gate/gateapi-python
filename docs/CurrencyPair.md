...
**trade_quotes** | **list[str]** | Quote currencies supported by the unified market; null means that the market does not support unified quote currencies | [optional] 
**fee** | **str** | Trading fee rate(deprecated) | [optional] 
