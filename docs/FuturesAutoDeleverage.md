...
**leverage** | **str** |  leverage for isolated margin. 0 means cross margin. For leverage of cross margin, please refer to &#x60;cross_leverage_limit&#x60;. | [optional] [readonly] 
**cross_leverage_limit** | **str** | leverage for cross margin | [optional] [readonly] 
