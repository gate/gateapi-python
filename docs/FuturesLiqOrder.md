...
**size** | **str** | User position size | [optional] [readonly] 
**order_size** | **str** | Number of forced liquidation orders | [optional] [readonly] 
...
**left** | **str** | Reserved field with no current business significance. | [optional] [readonly] 
