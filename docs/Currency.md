...
**total_supply** | **str** | Total supply | [optional] 
**market_cap** | **str** | Market cap | [optional] 
**category** | **list[str]** | Currency categories - stocks: Stocks - metals: Metals - indices: Indices - forex: Forex - commodities: Commodities | [optional] 
