...
**min_lend_amount** | **str** | Minimum earn amount | [optional] 
**user_max_lend_amount** | **str** | User maximum earn limit | [optional] 
**total_lend_amount** | **str** | Platform earn limit | [optional] 
...
**user_max_lend_volume** | **str** | User maximum earn amount | [optional] 
**user_total_amount** | **str** | Total amount the user has invested in earn products | [optional] 
