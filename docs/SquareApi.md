...
> ListSquareAiSearchResponse list_square_ai_search(keyword=keyword, currency=currency, time_range=time_range, sort=sort, limit=limit, page=page)
...
# **list_live_replay**
> ListLiveReplayResponse list_live_replay(tag=tag, coin=coin, sort=sort, limit=limit)
