...
**taker_fee** | **str** | spot taker fee rate | [optional] 
**maker_fee** | **str** | spot maker fee rate | [optional] 
**rpi_maker_fee** | **str** | spot RPI MM maker fee rate | [optional] 
...
**futures_rpi_maker_fee** | **str** | contract RPI MM maker fee rate | [optional] 
...
**rpi_mm** | **int** | RPI MM Level | [optional] 
