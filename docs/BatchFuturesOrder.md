...
**size** | **str** | Required. Trading quantity. Positive for buy, negative for sell. Set to 0 for close position orders. | [optional] 
...
**market_order_slip_ratio** | **str** | The maximum slippage ratio | [optional] 
