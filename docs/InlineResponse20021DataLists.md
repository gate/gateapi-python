...
------------ | ------------- | ------------- | -------------
**type** | **str** | Ad buy/sell direction | [optional] 
**rate** | **str** | Price | [optional] 
**original_rate** | **str** | Original price | [optional] 
**amount** | **str** | Remaining cryptocurrency amount of ad | [optional] 
...
**pay_type_json** | **str** | Payment method configuration details | [optional] 
...
**hide_payment** | **str** | Whether to hide payment method | [optional] 
**currency_type** | **str** | Digital currency | [optional] 
**want_type** | **str** | Fiat currency | [optional] 
**trade_tips** | **str** | Trading terms | [optional] 
**new_hand** | **int** | Special ad type | [optional] 
**id** | **str** | Ad ID | [optional] 
**status** | **str** | Ad status | [optional] 
