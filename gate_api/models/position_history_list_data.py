...
class PositionHistoryListData(object):
    ...
    @property
    def list(self):
        """Gets the list of this PositionHistoryListData.  # noqa: E501

        Query historical position list  # noqa: E501

        :return: The list of this PositionHistoryListData.  # noqa: E501
        :rtype: list[PositionHistoryListDataList]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this PositionHistoryListData.

        Query historical position list  # noqa: E501

        :param list: The list of this PositionHistoryListData.  # noqa: E501
        :type: list[PositionHistoryListDataList]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PositionHistoryListData):
            return False
