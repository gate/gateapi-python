...
class CandyDropV4TaskProgressCd04(object):
    ...
    openapi_types = {
        ...
        'start_time': 'str',
        'end_time': 'str',
        'tasks': 'list[CandyDropV4TaskProgressItemCd04]'
    }
    ...
    def __init__(self, currency=None, total_rewards=None, start_time=None, end_time=None, tasks=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, str, str, str, list[CandyDropV4TaskProgressItemCd04], Configuration) -> None
        """CandyDropV4TaskProgressCd04 - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CandyDropV4TaskProgressCd04):
            return False
