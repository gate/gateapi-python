...
class OtcQuoteRequest(object):
    ...
    def __init__(self, side=None, pay_coin=None, get_coin=None, pay_amount=None, get_amount=None, create_quote_token=None, promotion_code=None, local_vars_configuration=None):  # noqa: E501
        ...
        """OtcQuoteRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def pay_amount(self):
        """Gets the pay_amount of this OtcQuoteRequest.  # noqa: E501

        User payment currency amount  # noqa: E501

        :return: The pay_amount of this OtcQuoteRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def pay_amount(self, pay_amount):
        """Sets the pay_amount of this OtcQuoteRequest.

        User payment currency amount  # noqa: E501

        :param pay_amount: The pay_amount of this OtcQuoteRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def get_amount(self):
        """Gets the get_amount of this OtcQuoteRequest.  # noqa: E501

        Amount of currency received by the user  # noqa: E501

        :return: The get_amount of this OtcQuoteRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def get_amount(self, get_amount):
        """Sets the get_amount of this OtcQuoteRequest.

        Amount of currency received by the user  # noqa: E501

        :param get_amount: The get_amount of this OtcQuoteRequest.  # noqa: E501
        :type: str
        """
    ...
    def create_quote_token(self):
        """Gets the create_quote_token of this OtcQuoteRequest.  # noqa: E501

        Create quote token: 0: quote preview only; 1: generate quote token for order placement.  # noqa: E501

        :return: The create_quote_token of this OtcQuoteRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def create_quote_token(self, create_quote_token):
        """Sets the create_quote_token of this OtcQuoteRequest.

        Create quote token: 0: quote preview only; 1: generate quote token for order placement.  # noqa: E501

        :param create_quote_token: The create_quote_token of this OtcQuoteRequest.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OtcQuoteRequest):
            return False
