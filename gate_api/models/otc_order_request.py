...
class OtcOrderRequest(object):
    ...
    @property
    def type(self):
        """Gets the type of this OtcOrderRequest.  # noqa: E501

        BUY for on-ramp, SELL for off-ramp  # noqa: E501

        :return: The type of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OtcOrderRequest.

        BUY for on-ramp, SELL for off-ramp  # noqa: E501

        :param type: The type of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    @property
    def side(self):
        """Gets the side of this OtcOrderRequest.  # noqa: E501

        The side returned by the quote endpoint (used for order validation). For backward compatibility, `FIAT`/`CRYPTO` or `PAY`/`GET` are accepted; new integrations should use the value returned by the quote response.  # noqa: E501

        :return: The side of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
        return self._side
    ...
    @side.setter
    def side(self, side):
        """Sets the side of this OtcOrderRequest.

        The side returned by the quote endpoint (used for order validation). For backward compatibility, `FIAT`/`CRYPTO` or `PAY`/`GET` are accepted; new integrations should use the value returned by the quote response.  # noqa: E501

        :param side: The side of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def crypto_currency(self):
        """Gets the crypto_currency of this OtcOrderRequest.  # noqa: E501

        Cryptocurrency (supported currencies can be queried from the OTC web fiat quote page)  # noqa: E501

        :return: The crypto_currency of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def crypto_currency(self, crypto_currency):
        """Sets the crypto_currency of this OtcOrderRequest.

        Cryptocurrency (supported currencies can be queried from the OTC web fiat quote page)  # noqa: E501

        :param crypto_currency: The crypto_currency of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def fiat_currency(self):
        """Gets the fiat_currency of this OtcOrderRequest.  # noqa: E501

        Fiat currency (supported currencies can be queried from the OTC web fiat quote page)  # noqa: E501

        :return: The fiat_currency of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def fiat_currency(self, fiat_currency):
        """Sets the fiat_currency of this OtcOrderRequest.

        Fiat currency (supported currencies can be queried from the OTC web fiat quote page)  # noqa: E501

        :param fiat_currency: The fiat_currency of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def crypto_amount(self):
        """Gets the crypto_amount of this OtcOrderRequest.  # noqa: E501

        Amount of cryptocurrency  # noqa: E501

        :return: The crypto_amount of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def crypto_amount(self, crypto_amount):
        """Sets the crypto_amount of this OtcOrderRequest.

        Amount of cryptocurrency  # noqa: E501

        :param crypto_amount: The crypto_amount of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def fiat_amount(self):
        """Gets the fiat_amount of this OtcOrderRequest.  # noqa: E501

        Fiat amount  # noqa: E501

        :return: The fiat_amount of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def fiat_amount(self, fiat_amount):
        """Sets the fiat_amount of this OtcOrderRequest.

        Fiat amount  # noqa: E501

        :param fiat_amount: The fiat_amount of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def promotion_code(self):
        """Gets the promotion_code of this OtcOrderRequest.  # noqa: E501

        Promotion code  # noqa: E501

        :return: The promotion_code of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def promotion_code(self, promotion_code):
        """Sets the promotion_code of this OtcOrderRequest.

        Promotion code  # noqa: E501

        :param promotion_code: The promotion_code of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def quote_token(self):
        """Gets the quote_token of this OtcOrderRequest.  # noqa: E501

        Parameter returned by the quote API  # noqa: E501

        :return: The quote_token of this OtcOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def quote_token(self, quote_token):
        """Sets the quote_token of this OtcOrderRequest.

        Parameter returned by the quote API  # noqa: E501

        :param quote_token: The quote_token of this OtcOrderRequest.  # noqa: E501
        :type: str
        """
    ...
    def bank_id(self):
        ...
        Bank card ID used to place the order. Select one from the list returned by `GET /otc/bank/list`; the default card has `is_default=1`.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OtcOrderRequest):
            return False
