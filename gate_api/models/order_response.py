...
class OrderResponse(object):
    ...
    def status(self):
        ...
        Order Status - `0` : All - `1` : Processing - `2` : Successful - `3` : Failed - `4` : Cancelled - `5` : Buy order placed but transfer not completed - `6` : Order cancelled but transfer not completed  # noqa: E501
    ...
    def failed_reason(self):
        ...
        Failure reason (if applicable)  # noqa: E501
