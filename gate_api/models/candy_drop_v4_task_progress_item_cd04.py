...
class CandyDropV4TaskProgressItemCd04(object):
    ...
    def __init__(self, task_name=None, task_desc=None, value=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, str, str, Configuration) -> None
        """CandyDropV4TaskProgressItemCd04 - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CandyDropV4TaskProgressItemCd04):
            return False
