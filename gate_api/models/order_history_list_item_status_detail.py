...
class OrderHistoryListItemStatusDetail(object):
    ...
    def __init__(self, title=None, message=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, str, Configuration) -> None
        """OrderHistoryListItemStatusDetail - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderHistoryListItemStatusDetail):
            return False
