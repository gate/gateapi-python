...
class FuturesBatchAmendOrderRequest(object):
    ...
    def action_mode(self):
        """Gets the action_mode of this FuturesBatchAmendOrderRequest.  # noqa: E501
        ...
        :return: The action_mode of this FuturesBatchAmendOrderRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def action_mode(self, action_mode):
        """Sets the action_mode of this FuturesBatchAmendOrderRequest.

        Processing Mode  When placing an order, different fields are returned based on the action_mode  - `ACK`: Asynchronous mode, returns only key order fields - `RESULT`: No clearing information - `FULL`: Full mode (default)  # noqa: E501

        :param action_mode: The action_mode of this FuturesBatchAmendOrderRequest.  # noqa: E501
        :type: str
        """
