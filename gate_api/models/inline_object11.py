...
class InlineObject11(object):
    ...
    @property
    def text(self):
        """Gets the text of this InlineObject11.  # noqa: E501

        Client-defined Order ID, supports letters (a-z), numbers (0-9), symbols (-, _) only  # noqa: E501

        :return: The text of this InlineObject11.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this InlineObject11.

        Client-defined Order ID, supports letters (a-z), numbers (0-9), symbols (-, _) only  # noqa: E501

        :param text: The text of this InlineObject11.  # noqa: E501
        :type: str
        """
    ...
    @property
    def side(self):
        """Gets the side of this InlineObject11.  # noqa: E501

        BUY, SELL  # noqa: E501

        :return: The side of this InlineObject11.  # noqa: E501
        :rtype: str
        """
        return self._side
    ...
    @side.setter
    def side(self, side):
        """Sets the side of this InlineObject11.

        BUY, SELL  # noqa: E501

        :param side: The side of this InlineObject11.  # noqa: E501
        :type: str
        """
    ...
    def time_in_force(self):
        """Gets the time_in_force of this InlineObject11.  # noqa: E501
        ...
        :return: The time_in_force of this InlineObject11.  # noqa: E501
        :rtype: str
        """
    ...
    def time_in_force(self, time_in_force):
        """Sets the time_in_force of this InlineObject11.

        Default GTC, supports enumerated types: GTC, IOC, FOK, POC GTC: GoodTillCancelled IOC: ImmediateOrCancelled FOK: FillOrKill POC: PendingOrCancelled or PostOnly  # noqa: E501

        :param time_in_force: The time_in_force of this InlineObject11.  # noqa: E501
        :type: str
        """
    ...
    @property
    def qty(self):
        """Gets the qty of this InlineObject11.  # noqa: E501

        Order quantity (required unless spot market buy)  # noqa: E501

        :return: The qty of this InlineObject11.  # noqa: E501
        :rtype: str
        """
        return self._qty
    ...
    @qty.setter
    def qty(self, qty):
        """Sets the qty of this InlineObject11.

        Order quantity (required unless spot market buy)  # noqa: E501

        :param qty: The qty of this InlineObject11.  # noqa: E501
        :type: str
        """
    ...
    @property
    def price(self):
        """Gets the price of this InlineObject11.  # noqa: E501

        Limit Order Price (Required for Limit Orders)  # noqa: E501

        :return: The price of this InlineObject11.  # noqa: E501
        :rtype: str
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this InlineObject11.

        Limit Order Price (Required for Limit Orders)  # noqa: E501

        :param price: The price of this InlineObject11.  # noqa: E501
        :type: str
        """
    ...
    @property
    def quote_qty(self):
        """Gets the quote_qty of this InlineObject11.  # noqa: E501

        Order quote quantity; required for spot and margin market buy orders  # noqa: E501

        :return: The quote_qty of this InlineObject11.  # noqa: E501
        :rtype: str
        """
    ...
    def quote_qty(self, quote_qty):
        """Sets the quote_qty of this InlineObject11.

        Order quote quantity; required for spot and margin market buy orders  # noqa: E501

        :param quote_qty: The quote_qty of this InlineObject11.  # noqa: E501
        :type: str
        """
    ...
    def reduce_only(self):
        """Gets the reduce_only of this InlineObject11.  # noqa: E501

        Reduce-only: `true` or `false`  # noqa: E501

        :return: The reduce_only of this InlineObject11.  # noqa: E501
        :rtype: str
        """
    ...
    def reduce_only(self, reduce_only):
        """Sets the reduce_only of this InlineObject11.

        Reduce-only: `true` or `false`  # noqa: E501

        :param reduce_only: The reduce_only of this InlineObject11.  # noqa: E501
        :type: str
        """
    ...
    def position_side(self):
        """Gets the position_side of this InlineObject11.  # noqa: E501

        Position side: `NONE`, `LONG`, `SHORT` Defaults to `NONE` (single position mode) if not specified  # noqa: E501

        :return: The position_side of this InlineObject11.  # noqa: E501
        :rtype: str
        """
    ...
    def position_side(self, position_side):
        """Sets the position_side of this InlineObject11.

        Position side: `NONE`, `LONG`, `SHORT` Defaults to `NONE` (single position mode) if not specified  # noqa: E501

        :param position_side: The position_side of this InlineObject11.  # noqa: E501
        :type: str
        """
