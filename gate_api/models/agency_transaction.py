...
class AgencyTransaction(object):
    ...
    def __init__(self, transaction_time=None, user_id=None, group_name=None, fee=None, fee_asset=None, currency_pair=None, amount=None, amount_asset=None, source=None, local_vars_configuration=None):  # noqa: E501
