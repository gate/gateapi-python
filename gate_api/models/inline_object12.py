...
class InlineObject12(object):
    ...
    @property
    def text(self):
        """Gets the text of this InlineObject12.  # noqa: E501

        Client-defined Order ID, supports letters (a-z), numbers (0-9), symbols (-, _) only  # noqa: E501

        :return: The text of this InlineObject12.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this InlineObject12.

        Client-defined Order ID, supports letters (a-z), numbers (0-9), symbols (-, _) only  # noqa: E501

        :param text: The text of this InlineObject12.  # noqa: E501
        :type: str
        """
    ...
    @property
    def symbol(self):
        """Gets the symbol of this InlineObject12.  # noqa: E501
        ...
        :return: The symbol of this InlineObject12.  # noqa: E501
        :rtype: str
        """
        return self._symbol
    ...
    def symbol(self, symbol):
        """Sets the symbol of this InlineObject12.

        Unique Identifier Exchange_Business_Base_Counter Examples: - To place a Spot order for ADA/USDT on BINANCE: Use identifier `BINANCE_SPOT_ADA_USDT`;   - To place a USDT-margined Perpetual Futures order for ADA/USDT on OKX: Use identifier `OKX_FUTURE_ADA_USDT`;   - To place a Spot Margin order for ADA/USDT on GATE: Use identifier `GATE_MARGIN_ADA_USDT`;   - To place a Spot order for ADA/USDT on BYBIT: Use identifier `BYBIT_SPOT_ADA_USDT`;   Currently supports three order types: Spot orders, USDT-margined Perpetual Futures orders, and Spot Margin orders. BYBIT does not currently support Spot Margin orders  # noqa: E501

        :param symbol: The symbol of this InlineObject12.  # noqa: E501
        :type: str
        """
    ...
    @property
    def side(self):
        """Gets the side of this InlineObject12.  # noqa: E501

        BUY, SELL  # noqa: E501

        :return: The side of this InlineObject12.  # noqa: E501
        :rtype: str
        """
        return self._side
    ...
    @side.setter
    def side(self, side):
        """Sets the side of this InlineObject12.

        BUY, SELL  # noqa: E501

        :param side: The side of this InlineObject12.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this InlineObject12.  # noqa: E501

        Order type (default: `LIMIT`; supported types: `LIMIT`, `MARKET`)  # noqa: E501

        :return: The type of this InlineObject12.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this InlineObject12.

        Order type (default: `LIMIT`; supported types: `LIMIT`, `MARKET`)  # noqa: E501

        :param type: The type of this InlineObject12.  # noqa: E501
        :type: str
        """
    ...
    def time_in_force(self):
        """Gets the time_in_force of this InlineObject12.  # noqa: E501
        ...
        :return: The time_in_force of this InlineObject12.  # noqa: E501
        :rtype: str
        """
    ...
    def time_in_force(self, time_in_force):
        """Sets the time_in_force of this InlineObject12.

        Default GTC, supports enumerated types: GTC, IOC, FOK, POC GTC: GoodTillCancelled IOC: ImmediateOrCancelled FOK: FillOrKill POC: PendingOrCancelled or PostOnly  # noqa: E501

        :param time_in_force: The time_in_force of this InlineObject12.  # noqa: E501
        :type: str
        """
    ...
    @property
    def quote_qty(self):
        """Gets the quote_qty of this InlineObject12.  # noqa: E501

        Order quote quantity; required for spot and margin market buy orders  # noqa: E501

        :return: The quote_qty of this InlineObject12.  # noqa: E501
        :rtype: str
        """
    ...
    def quote_qty(self, quote_qty):
        """Sets the quote_qty of this InlineObject12.

        Order quote quantity; required for spot and margin market buy orders  # noqa: E501

        :param quote_qty: The quote_qty of this InlineObject12.  # noqa: E501
        :type: str
        """
    ...
    def reduce_only(self):
        """Gets the reduce_only of this InlineObject12.  # noqa: E501

        Reduce-only: `true` or `false`  # noqa: E501

        :return: The reduce_only of this InlineObject12.  # noqa: E501
        :rtype: str
        """
    ...
    def reduce_only(self, reduce_only):
        """Sets the reduce_only of this InlineObject12.

        Reduce-only: `true` or `false`  # noqa: E501

        :param reduce_only: The reduce_only of this InlineObject12.  # noqa: E501
        :type: str
        """
    ...
    def position_side(self):
        """Gets the position_side of this InlineObject12.  # noqa: E501

        Position side: `NONE`, `LONG`, `SHORT` Defaults to `NONE` (single position mode) if not specified  # noqa: E501

        :return: The position_side of this InlineObject12.  # noqa: E501
        :rtype: str
        """
    ...
    def position_side(self, position_side):
        """Sets the position_side of this InlineObject12.

        Position side: `NONE`, `LONG`, `SHORT` Defaults to `NONE` (single position mode) if not specified  # noqa: E501

        :param position_side: The position_side of this InlineObject12.  # noqa: E501
        :type: str
        """
