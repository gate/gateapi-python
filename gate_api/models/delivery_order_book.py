...
class DeliveryOrderBook(object):
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DeliveryOrderBook.

        Order Book ID. Increases by 1 on every order book change. Set `with_id=true` to include this field in response  # noqa: E501

        :param id: The id of this DeliveryOrderBook.  # noqa: E501
        :type: int
        """
    ...
    @property
    def current(self):
        """Gets the current of this DeliveryOrderBook.  # noqa: E501

        Response data generation timestamp  # noqa: E501

        :return: The current of this DeliveryOrderBook.  # noqa: E501
        :rtype: float
        """
    ...
    def current(self, current):
        """Sets the current of this DeliveryOrderBook.

        Response data generation timestamp  # noqa: E501

        :param current: The current of this DeliveryOrderBook.  # noqa: E501
        :type: float
        """
    ...
    @property
    def update(self):
        """Gets the update of this DeliveryOrderBook.  # noqa: E501

        Order book changed timestamp  # noqa: E501

        :return: The update of this DeliveryOrderBook.  # noqa: E501
        :rtype: float
        """
        return self._update
    ...
    def update(self, update):
        """Sets the update of this DeliveryOrderBook.

        Order book changed timestamp  # noqa: E501

        :param update: The update of this DeliveryOrderBook.  # noqa: E501
        :type: float
        """
    ...
    @property
    def asks(self):
        """Gets the asks of this DeliveryOrderBook.  # noqa: E501
    ...
    @asks.setter
    def asks(self, asks):
        """Sets the asks of this DeliveryOrderBook.
    ...
    @property
    def bids(self):
        """Gets the bids of this DeliveryOrderBook.  # noqa: E501
    ...
    @bids.setter
    def bids(self, bids):
        """Sets the bids of this DeliveryOrderBook.
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeliveryOrderBook):
            return False
