...
class SymbolDetailData(object):
    ...
    def __init__(self, total=None, total_page=None, list=None, local_vars_configuration=None):  # noqa: E501
        # type: (int, int, list[SymbolDetailItem], Configuration) -> None
        """SymbolDetailData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def list(self):
        """Gets the list of this SymbolDetailData.  # noqa: E501


        :return: The list of this SymbolDetailData.  # noqa: E501
        :rtype: list[SymbolDetailItem]
        """
        return self._list

    @list.setter
    def list(self, list):
        """Sets the list of this SymbolDetailData.


        :param list: The list of this SymbolDetailData.  # noqa: E501
        :type: list[SymbolDetailItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SymbolDetailData):
            return False
