...
class CreateOrderData(object):
    ...
    def __init__(self, id=None, local_vars_configuration=None):  # noqa: E501
        ...
        """CreateOrderData - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this CreateOrderData.  # noqa: E501

        Queue Task ID (not task ID)  # noqa: E501

        :return: The id of this CreateOrderData.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CreateOrderData.

        Queue Task ID (not task ID)  # noqa: E501

        :param id: The id of this CreateOrderData.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateOrderData):
            return False
