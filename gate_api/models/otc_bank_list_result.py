...
class OtcBankListResult(object):
    ...
    def __init__(self, lists=None, local_vars_configuration=None):  # noqa: E501
        # type: (list[OtcBankListItem], Configuration) -> None
        """OtcBankListResult - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def lists(self):
        """Gets the lists of this OtcBankListResult.  # noqa: E501

        Bank card list  # noqa: E501

        :return: The lists of this OtcBankListResult.  # noqa: E501
        :rtype: list[OtcBankListItem]
        """
        return self._lists

    @lists.setter
    def lists(self, lists):
        """Sets the lists of this OtcBankListResult.

        Bank card list  # noqa: E501

        :param lists: The lists of this OtcBankListResult.  # noqa: E501
        :type: list[OtcBankListItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OtcBankListResult):
            return False
