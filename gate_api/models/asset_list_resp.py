...
class AssetListResp(object):
    ...
    def __init__(self, list=None, local_vars_configuration=None):  # noqa: E501
        ...
        """AssetListResp - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def list(self):
        """Gets the list of this AssetListResp.  # noqa: E501


        :return: The list of this AssetListResp.  # noqa: E501
        :rtype: list[str]
        """
        return self._list
    ...
    @list.setter
    def list(self, list):
        """Sets the list of this AssetListResp.


        :param list: The list of this AssetListResp.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssetListResp):
            return False
