...
class PlaceDualInvestmentOrderParams(object):
    ...
    def __init__(self, plan_id=None, amount=None, text=None, local_vars_configuration=None):  # noqa: E501
        ...
        """PlaceDualInvestmentOrderParams - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def plan_id(self):
        """Gets the plan_id of this PlaceDualInvestmentOrderParams.  # noqa: E501

        Product ID  # noqa: E501

        :return: The plan_id of this PlaceDualInvestmentOrderParams.  # noqa: E501
        :rtype: str
        """
    ...
    def plan_id(self, plan_id):
        """Sets the plan_id of this PlaceDualInvestmentOrderParams.

        Product ID  # noqa: E501

        :param plan_id: The plan_id of this PlaceDualInvestmentOrderParams.  # noqa: E501
        :type: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this PlaceDualInvestmentOrderParams.  # noqa: E501
        ...
        :return: The text of this PlaceDualInvestmentOrderParams.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this PlaceDualInvestmentOrderParams.

        Order custom information. Users can set custom ID with this field. Custom fields must meet the following conditions:  1. Must start with `t-` 2. Excluding `t-`, length cannot exceed 28 bytes 3. Can only contain numbers, letters, underscore(_), hyphen(-) or dot(.)   # noqa: E501

        :param text: The text of this PlaceDualInvestmentOrderParams.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PlaceDualInvestmentOrderParams):
            return False
