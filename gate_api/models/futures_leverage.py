...
class FuturesLeverage(object):
    ...
    def __init__(self, lever=None, local_vars_configuration=None):  # noqa: E501
        # type: (str, Configuration) -> None
        """FuturesLeverage - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FuturesLeverage):
            return False
