...
class CrossexTransferRecord(object):
    ...
    def __init__(self, id=None, text=None, from_account_type=None, to_account_type=None, coin=None, amount=None, actual_receive=None, status=None, fail_reason=None, create_time=None, update_time=None, local_vars_configuration=None):  # noqa: E501
        ...
        """CrossexTransferRecord - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this CrossexTransferRecord.  # noqa: E501

        Order ID  # noqa: E501

        :return: The id of this CrossexTransferRecord.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this CrossexTransferRecord.

        Order ID  # noqa: E501

        :param id: The id of this CrossexTransferRecord.  # noqa: E501
        :type: str
        """
    ...
    @property
    def text(self):
        """Gets the text of this CrossexTransferRecord.  # noqa: E501

        Client Custom ID  # noqa: E501

        :return: The text of this CrossexTransferRecord.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this CrossexTransferRecord.

        Client Custom ID  # noqa: E501

        :param text: The text of this CrossexTransferRecord.  # noqa: E501
        :type: str
        """
    ...
    @property
    def coin(self):
        """Gets the coin of this CrossexTransferRecord.  # noqa: E501

        Currency  # noqa: E501

        :return: The coin of this CrossexTransferRecord.  # noqa: E501
        :rtype: str
        """
        return self._coin
    ...
    @coin.setter
    def coin(self, coin):
        """Sets the coin of this CrossexTransferRecord.

        Currency  # noqa: E501

        :param coin: The coin of this CrossexTransferRecord.  # noqa: E501
        :type: str
        """
    ...
    @property
    def amount(self):
        """Gets the amount of this CrossexTransferRecord.  # noqa: E501

        Transfer amount, the amount requested for the transfer  # noqa: E501

        :return: The amount of this CrossexTransferRecord.  # noqa: E501
        :rtype: str
        """
        return self._amount
    ...
    def amount(self, amount):
        """Sets the amount of this CrossexTransferRecord.

        Transfer amount, the amount requested for the transfer  # noqa: E501

        :param amount: The amount of this CrossexTransferRecord.  # noqa: E501
        :type: str
        """
    ...
    def actual_receive(self):
        """Gets the actual_receive of this CrossexTransferRecord.  # noqa: E501

        Actual credited amount (has a value when status = SUCCESS; empty for other statuses)  # noqa: E501

        :return: The actual_receive of this CrossexTransferRecord.  # noqa: E501
        :rtype: str
        """
    ...
    def actual_receive(self, actual_receive):
        """Sets the actual_receive of this CrossexTransferRecord.

        Actual credited amount (has a value when status = SUCCESS; empty for other statuses)  # noqa: E501

        :param actual_receive: The actual_receive of this CrossexTransferRecord.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this CrossexTransferRecord.  # noqa: E501

        Transfer Status - `FAIL`: Failed - `SUCCESS`: Successful - `PENDING`: Transfer in Progress  # noqa: E501

        :return: The status of this CrossexTransferRecord.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CrossexTransferRecord.

        Transfer Status - `FAIL`: Failed - `SUCCESS`: Successful - `PENDING`: Transfer in Progress  # noqa: E501

        :param status: The status of this CrossexTransferRecord.  # noqa: E501
        :type: str
        """
    ...
    def fail_reason(self):
        """Gets the fail_reason of this CrossexTransferRecord.  # noqa: E501

        Failure reason (has a value when status = FAIL; empty for other statuses)  # noqa: E501

        :return: The fail_reason of this CrossexTransferRecord.  # noqa: E501
        :rtype: str
        """
    ...
    def fail_reason(self, fail_reason):
        """Sets the fail_reason of this CrossexTransferRecord.

        Failure reason (has a value when status = FAIL; empty for other statuses)  # noqa: E501

        :param fail_reason: The fail_reason of this CrossexTransferRecord.  # noqa: E501
        :type: str
        """
    ...
    def create_time(self):
        """Gets the create_time of this CrossexTransferRecord.  # noqa: E501

        Creation time of order  # noqa: E501

        :return: The create_time of this CrossexTransferRecord.  # noqa: E501
        :rtype: int
        """
    ...
    def create_time(self, create_time):
        """Sets the create_time of this CrossexTransferRecord.

        Creation time of order  # noqa: E501

        :param create_time: The create_time of this CrossexTransferRecord.  # noqa: E501
        :type: int
        """
    ...
    def update_time(self):
        """Gets the update_time of this CrossexTransferRecord.  # noqa: E501

        OrderUpdateTime  # noqa: E501

        :return: The update_time of this CrossexTransferRecord.  # noqa: E501
        :rtype: int
        """
    ...
    def update_time(self, update_time):
        """Sets the update_time of this CrossexTransferRecord.

        OrderUpdateTime  # noqa: E501

        :param update_time: The update_time of this CrossexTransferRecord.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CrossexTransferRecord):
            return False
