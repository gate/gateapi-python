...
class HodlerAirdropV4ErrorResponse(object):
    ...
    def __init__(self, label=None, message=None, local_vars_configuration=None):  # noqa: E501
        ...
        """HodlerAirdropV4ErrorResponse - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def label(self):
        """Gets the label of this HodlerAirdropV4ErrorResponse.  # noqa: E501

        Error label  # noqa: E501

        :return: The label of this HodlerAirdropV4ErrorResponse.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this HodlerAirdropV4ErrorResponse.

        Error label  # noqa: E501

        :param label: The label of this HodlerAirdropV4ErrorResponse.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and label is None:  # noqa: E501
            raise ValueError("Invalid value for `label`, must not be `None`")  # noqa: E501
        allowed_values = ["INVALID_PARAM_VALUE", "UNAUTHORIZED", "FORBIDDEN", "INELIGIBLE", "KYC_REQUIRED", "RISK_CONTROL", "SERVER_ERROR"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HodlerAirdropV4ErrorResponse):
            return False
