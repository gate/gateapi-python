...
class WalletApi(object):
    ...
    def get_transfer(self, tx_id, **kwargs):  # noqa: E501
        """Get trading account transfer  # noqa: E501

        Get the current user's trading account transfer details using the tx_id returned by the transfer endpoint  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transfer(tx_id, async_req=True)
        >>> result = thread.get()

        :param bool async_req: execute request asynchronously
        :param str tx_id: Transfer transaction ID (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :rtype: gate_api.AccountTransferDetail
        :return: If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.get_transfer_with_http_info(tx_id, **kwargs)  # noqa: E501

    def get_transfer_with_http_info(self, tx_id, **kwargs):  # noqa: E501
        """Get trading account transfer  # noqa: E501

        Get the current user's trading account transfer details using the tx_id returned by the transfer endpoint  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_transfer_with_http_info(tx_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :rtype: tuple(gate_api.AccountTransferDetail, status_code(int), headers(HTTPHeaderDict))
        :return: If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for k, v in six.iteritems(local_var_params['kwargs']):
            if k not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_transfer" % k
                )
            local_var_params[k] = v
        del local_var_params['kwargs']
        # verify the required parameter 'tx_id' is set
        if self.api_client.client_side_validation and ('tx_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['tx_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `tx_id` when calling `get_transfer`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='AccountTransferDetail',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
