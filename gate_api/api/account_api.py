...
class AccountApi(object):
    ...
    def get_account_main_keys(self, **kwargs):  # noqa: E501
        """Query All Main Account Key Information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_main_keys(async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_account_main_keys_with_http_info(**kwargs)  # noqa: E501

    def get_account_main_keys_with_http_info(self, **kwargs):  # noqa: E501
        """Query All Main Account Key Information  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_account_main_keys_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for k, v in six.iteritems(local_var_params['kwargs']):
            if k not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_account_main_keys" % k
                )
            local_var_params[k] = v
        del local_var_params['kwargs']
